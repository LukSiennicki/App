...
public class RequestBuilderTest {
    ...
    public void should_build_request_with_default_parameters(){
        ...
        String expected = "http://api.nbp.pl/api/exchangerates/rates/c/JPY/" + getCurrentExpectedDate() + "?format=JSON";
        Assert.assertEquals(result.url().toString(), expected);
    }

    @Test
    public void should_build_request_with_default_currency_when_pass_null_parameters(){
    ...
    @Test
    public void should_build_request_with_default_dataFormat_when_pass_null_parameters(){
        final Request result = new RequestBuilder()
                .dataFormat(null)
                .build();
        String expected = "http://api.nbp.pl/api/exchangerates/rates/c/JPY/" + getCurrentExpectedDate() + "?format=JSON";
    ...
    @Test
    public void should_build_request_with_default_date_when_pass_null_parameters(){
        final Request result = new RequestBuilder()
                .date(null)
                .build();
        String expected = "http://api.nbp.pl/api/exchangerates/rates/c/JPY/" + getCurrentExpectedDate() + "?format=JSON";
    ...
    public void should_build_request_with_good_date(){
        ...
        String expected = "http://api.nbp.pl/api/exchangerates/rates/c/JPY/2020-09-04?format=JSON";
        Assert.assertEquals(result.url().toString(), expected);
    }

    @Test
    public void should_build_request_with_JSON_as_data_format(){
